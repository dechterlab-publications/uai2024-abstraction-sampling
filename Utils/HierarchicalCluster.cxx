    ...
    if(len <= numClusters){
        ...
        for(uint32_t round = 0; round < numRounds; ++round){
            ...
            do{
                ...
                minDist.pop();
            } while(dist1 != adjacentDist[idx1]); // check to make sure popped element corresponds to updated dists
            ...
            adjacentDist[idx2] = NAN; //implicitly marks cluster idx2 as removed
