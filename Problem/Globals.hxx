...
#define LOG_OF_SUB_OF_TWO_NUMBERS_GIVEN_AS_LOGS(sub,x,y) { if (x == y) sub = - std::numeric_limits<double>::infinity() ; else if (x > y) sub = x + log10(1.0 - pow(10.0, y - x)) ; else sub = y + log10(pow(10.0, x - y) - 1.0) ; }
